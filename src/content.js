  ...
  it: {
    ...
    about: {
      ...
      facts: [
        ...
        { label: "Sede", value: "Monaco di Baviera · Disponibile a trasferte" },
        { label: "Lingue", value: "Italiano (madrelingua) · Inglese (C1) · Tedesco (C1) · Spagnolo (B1) · Portoghese (A2) · Gallese (A2)" },
        { label: "Interessi extracurricolari", value: "Letteratura · Scrittura creativa · Lingue e culture straniere" },
      ],
    },
    experience: {
      sectionNum: "02",
  ...
  de: {
    ...
    about: {
      ...
      facts: [
        ...
        { label: "Sprachen", value: "Italienisch (Muttersprache) · Englisch (C1) · Deutsch (C1) · Spanisch (B1) ·  Portugiesisch (A2) · Walisisch (A2)" },
        { label: "Interessen", value: "Literatur · Kreatives Schreiben · Fremdsprachen und -Kulturen" },
      ],
    },
    experience: {
      sectionNum: "02",
